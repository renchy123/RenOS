...
00007C85  E8F600            call 0x7d7e
00007C88  8B0EDE7D          mov cx,[0x7dde]
00007C8C  E80E00            call 0x7c9d
00007C8F  EB09              jmp short 0x7c9a
00007C91  BDAC7D            mov bp,0x7dac
00007C94  B90D00            mov cx,0xd
00007C97  E8CB00            call 0x7d65
00007C9A  F4                hlt
...
00007DBD  45                inc bp
00007DBE  52                push dx
00007DBF  2020              and [bx+si],ah
00007DC1  2020              and [bx+si],ah
00007DC3  2000              and [bx+si],al
