...
0000901A  40                inc ax
0000901B  00FF              add bh,bh
0000901D  0F0000            sldt [bx+si]
00009020  00924000          add [bp+si+0x40],dl
00009024  0D0000            or ax,0x0
00009027  0000              add [bx+si],al
00009029  98                cbw
0000902A  40                inc ax
0000902B  0000              add [bx+si],al
0000902D  0020              add [bx+si],ah
0000902F  0000              add [bx+si],al
00009031  8C00              mov [bx+si],es
00009033  0007              add [bx],al
00009035  0020              add [bx+si],ah
00009037  0000              add [bx+si],al
00009039  8C00              mov [bx+si],es
0000903B  0037              add [bx],dh
0000903D  0000              add [bx+si],al
0000903F  0000              add [bx+si],al
00009041  0000              add [bx+si],al
00009043  005765            add [bx+0x65],dl
00009046  6C                insb
00009047  636F6D            arpl [bx+0x6d],bp
0000904A  6520546F          and [gs:si+0x6f],dl
0000904E  205265            and [bp+si+0x65],dl
00009051  6E                outsb
00009052  4F                dec di
00009053  53                push bx
00009054  2021              and [bx+di],ah
00009056  2121              and [bx+di],sp
00009058  004865            add [bx+si+0x65],cl
0000905B  6C                insb
0000905C  6C                insb
0000905D  6F                outsw
0000905E  20576F            and [bx+0x6f],dl
00009061  726C              jc 0x90cf
00009063  642021            and [fs:bx+di],ah
00009066  0000              add [bx+si],al
00009068  8CC8              mov ax,cs
0000906A  8ED8              mov ds,ax
0000906C  8EC0              mov es,ax
0000906E  8ED0              mov ss,ax
00009070  BC007C            mov sp,0x7c00
00009073  66BEF8900000      mov esi,0x90f8
00009079  66BF0C900000      mov edi,0x900c
0000907F  E85200            call 0x90d4
00009082  66BE2C910000      mov esi,0x912c
00009088  66BF1C900000      mov edi,0x901c
0000908E  E84300            call 0x90d4
00009091  66BE1C910000      mov esi,0x911c
00009097  66BF24900000      mov edi,0x9024
0000909D  E83400            call 0x90d4
000090A0  66B800000000      mov eax,0x0
000090A6  8CD8              mov ax,ds
000090A8  66C1E004          shl eax,byte 0x4
000090AC  660504900000      add eax,0x9004
000090B2  66A33E90          mov [0x903e],eax
000090B6  0F01163C90        lgdt [0x903c]
000090BB  FA                cli
000090BC  E492              in al,0x92
000090BE  0C02              or al,0x2
000090C0  E692              out 0x92,al
000090C2  0F20C0            mov eax,cr0
000090C5  6683C801          or eax,byte +0x1
000090C9  0F22C0            mov cr0,eax
000090CC  66EA000000000800  jmp dword 0x8:0x0
000090D4  6650              push eax
000090D6  66B800000000      mov eax,0x0
000090DC  8CC8              mov ax,cs
000090DE  66C1E004          shl eax,byte 0x4
000090E2  6601F0            add eax,esi
000090E5  67894702          mov [edi+0x2],ax
000090E9  66C1E810          shr eax,byte 0x10
000090ED  67884704          mov [edi+0x4],al
000090F1  67886707          mov [edi+0x7],ah
000090F5  6658              pop eax
000090F7  C3                ret
000090F8  66B810008EE8      mov eax,0xe88e0010
000090FE  66B818008ED0      mov eax,0xd08e0018
00009104  B8FF0F            mov ax,0xfff
00009107  0000              add [bx+si],al
00009109  89C4              mov sp,ax
0000910B  66B8020066BB      mov eax,0xbb660002
00009111  0100              add [bx+si],ax
00009113  9A00000000        call 0x0:0x0
00009118  2800              sub [bx+si],al
0000911A  EBFE              jmp short 0x911a
0000911C  6689C1            mov ecx,eax
0000911F  6601D9            add ecx,ebx
00009122  CB                retf
00009123  6689C1            mov ecx,eax
00009126  6629D9            sub ecx,ebx
00009129  CB                retf
