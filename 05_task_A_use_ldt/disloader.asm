...
00009028  00924000          add [bp+si+0x40],dl
0000902C  FF                db 0xff
0000902D  FF00              inc word [bx+si]
0000902F  0000              add [bx+si],al
00009031  98                cbw
00009032  0000              add [bx+si],al
00009034  FF                db 0xff
00009035  FF00              inc word [bx+si]
00009037  0000              add [bx+si],al
00009039  92                xchg ax,dx
...
00009073  A34791            mov [0x9147],ax
00009076  66BE4C910000      mov esi,0x914c
0000907C  66BF0C900000      mov edi,0x900c
00009082  E86100            call 0x90e6
00009085  66BE44900000      mov esi,0x9044
0000908B  66BF1C900000      mov edi,0x901c
00009091  E85200            call 0x90e6
00009094  66BEB4910000      mov esi,0x91b4
0000909A  66BF24900000      mov edi,0x9024
000090A0  E84300            call 0x90e6
000090A3  66BE2F910000      mov esi,0x912f
000090A9  66BF2C900000      mov edi,0x902c
000090AF  E83400            call 0x90e6
000090B2  66B800000000      mov eax,0x0
000090B8  8CD8              mov ax,ds
000090BA  66C1E004          shl eax,byte 0x4
000090BE  660504900000      add eax,0x9004
000090C4  66A33E90          mov [0x903e],eax
000090C8  0F01163C90        lgdt [0x903c]
000090CD  FA                cli
000090CE  E492              in al,0x92
000090D0  0C02              or al,0x2
000090D2  E692              out 0x92,al
000090D4  0F20C0            mov eax,cr0
000090D7  6683C801          or eax,byte +0x1
000090DB  0F22C0            mov cr0,eax
000090DE  66EA000000000800  jmp dword 0x8:0x0
000090E6  6650              push eax
000090E8  66B800000000      mov eax,0x0
000090EE  8CC8              mov ax,cs
000090F0  66C1E004          shl eax,byte 0x4
000090F4  6601F0            add eax,esi
000090F7  67894702          mov [edi+0x2],ax
000090FB  66C1E810          shr eax,byte 0x10
000090FF  67884704          mov [edi+0x4],al
00009103  67886707          mov [edi+0x7],ah
00009107  6658              pop eax
00009109  C3                ret
0000910A  8CC8              mov ax,cs
0000910C  8ED8              mov ds,ax
0000910E  8EC0              mov es,ax
00009110  8ED0              mov ss,ax
00009112  BC007C            mov sp,0x7c00
00009115  E492              in al,0x92
00009117  24FD              and al,0xfd
00009119  E692              out 0x92,al
0000911B  FB                sti
0000911C  BD5990            mov bp,0x9059
0000911F  B90C00            mov cx,0xc
00009122  BA0000            mov dx,0x0
00009125  B80113            mov ax,0x1301
00009128  BB0700            mov bx,0x7
0000912B  CD10              int 0x10
0000912D  EBFE              jmp short 0x912d
0000912F  B83000            mov ax,0x30
00009132  8ED8              mov ds,ax
00009134  8EC0              mov es,ax
00009136  8EE0              mov fs,ax
00009138  8EE8              mov gs,ax
0000913A  8ED0              mov ss,ax
0000913C  0F20C0            mov eax,cr0
0000913F  24FE              and al,0xfe
00009141  0F22C0            mov cr0,eax
00009144  EA0A910000        jmp 0x0:0x910a
00009149  0000              add [bx+si],al
0000914B  0066B8            add [bp-0x48],ah
0000914E  1000              adc [bx+si],al
00009150  8EE8              mov gs,ax
00009152  66B818008ED8      mov eax,0xd88e0018
00009158  66B820008ED0      mov eax,0xd08e0020
0000915E  B8FF0F            mov ax,0xfff
00009161  0000              add [bx+si],al
00009163  89C4              mov sp,ax
00009165  BD0000            mov bp,0x0
00009168  0000              add [bx+si],al
0000916A  66BB0C00B60C      mov ebx,0xcb6000c
00009170  B21C              mov dl,0x1c
00009172  E80700            call 0x917c
00009175  0000              add [bx+si],al
00009177  EA00000000        jmp 0x0:0x0
0000917C  2800              sub [bx+si],al
0000917E  55                push bp
0000917F  50                push ax
00009180  57                push di
00009181  6651              push ecx
00009183  6652              push edx
00009185  3E8A4D00          mov cl,[ds:di+0x0]
00009189  80F900            cmp cl,0x0
0000918C  741B              jz 0x91a9
0000918E  B85000            mov ax,0x50
00009191  0000              add [bx+si],al
00009193  F6E6              mul dh
00009195  00D0              add al,dl
00009197  66D1E0            shl eax,1
0000919A  89C7              mov di,ax
0000919C  88DC              mov ah,bl
0000919E  88C8              mov al,cl
000091A0  65668907          mov [gs:bx],eax
000091A4  45                inc bp
000091A5  FEC2              inc dl
000091A7  EBDC              jmp short 0x9185
000091A9  665A              pop edx
000091AB  6659              pop ecx
000091AD  5F                pop di
000091AE  58                pop ax
000091AF  5D                pop bp
000091B0  C3                ret
